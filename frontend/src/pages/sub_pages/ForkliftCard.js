...
const ForkliftCard = ({props}) => {
  ...
  useEffect(() => {
    const fetchStocks = async () => {
      ...
      if(response.ok){
        dispatch({type: 'GET_FORKLIFTS', payload: json})
      }
  ...
  return (
    ...
    <div>
      ...
      <Navbar collapseOnSelect expand="lg" variant="dark" sticky="top" className='nav-bar-edit'>
        <Container>
          <Navbar.Brand>Vehicles - Forklifts</Navbar.Brand>
      ...
      <h1 className='table-name'>
        ...
        <h2 className='table-info'>
          Forklift management and registration
        </h2>
        ...
        <Button aria-describedby={id} variant="contained" onClick={handleClick} className="map-btn">
              ...
              >
                ...
                <GoogleMap zoom={12} center={{lat: 6.915105 , lng: 79.972354}} mapContainerClassName="map-container">
                  <MarkerF position={{ lat: 6.915105, lng: 79.972234 }} />
                </GoogleMap>
                </div>
              </Popover>
                ...
                {vehicle.status === "OnRoute" && <Button className="delete-edit" onClick={(e) => {}} href="/VehicleDataInfo">View Assignment</Button>}
                    {vehicle.status === "Available" && <Button className="delete-edit" onClick={(e) => {}} href="/VehicleDataInfo" disabled>View Assignment</Button>}
